...
public class TransactionTest {
    private static final Movie FINDING_NEMO = new Movie("Finding Nemo", true);
    private static final Movie SHAWSHANK_REDEMPTION = new Movie("Shawshank Redemption", true);
